it ('login test', function() {
    ...
    cy.get('[data-text="SPO12547"] > .vs-select--item > span').click({force:true})
    cy.get('.vs-checkbox--input').check()
    cy.get(':nth-child(7) > :nth-child(1) > .vs-component > .vs-con-input > .vs-inputx').type()
